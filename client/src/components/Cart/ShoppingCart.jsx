      ...
      <div className="container grid grid-cols-[1fr_280px]  gap-6 my-4  bg-white">
        ...
        <div className=" border px-4 py-6 rounded-md">
          <div className="md:flex justify-between border-b pb-6 mb-2">
            <div className="flex   space-x-3">
              ...
              <div className="space-y-1">
                ...
                <div className="flex itemms-center">
                  <button className="text-xs text-red-500 cursor-pointer border  px-2 py-1 rounded-md ">
                    Remove
                  </button>
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex justify-end ">
                <p className="font-medium">$78.99</p>
              </div>
          ...
          <div className="md:flex justify-between items-center">
            ...
            <button className="flex items-center space-x-2 bg-transparent text-[#0D6EFD] px-5  py-2 rounded-md border shadow hover:scale-105 transition-all duration-300">
              Remove all
            </button>
          </div>
        </div>
