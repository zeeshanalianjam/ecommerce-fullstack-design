  ...
  return (
    <section className="container mx-auto px-4 my-4">
      <div className="grid grid-cols-[250px_1fr]  border-t  rounded-md">
        ...
        {/* Left Fixed Column */}
        <div style={{ backgroundImage: `url(${outdoor})`, backgroundSize: 'cover', backgroundPosition: 'center' }} className="bg-white p-4 shadow rounded-tl rounded-bl border">
          <h2 className="text-xl font-bold">Home & <br /> Outdoor</h2>
