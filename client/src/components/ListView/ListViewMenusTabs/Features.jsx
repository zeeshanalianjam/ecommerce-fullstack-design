     ...
     <div className="w-full text-gray-800 border-t my-4">
      ...
      {isOpen && (
        <div className=" ">
          ...
          >
            <input type="checkbox" id="samsung" className="w-4 h-4 accent-blue-600"/>
            <label htmlFor="samsung">Plastic cover</label>
          </div>
          <div
            className="
               font-medium text-gray-600
          ...
          >
            <input type="checkbox" id="samsung" className="w-4 h-4 accent-blue-600"/>
            <label htmlFor="samsung">8GB Ram</label>
          </div>
          <div
            className="
               font-medium text-gray-600
          ...
          >
            <input type="checkbox" id="samsung" className="w-4 h-4 accent-blue-600"/>
            <label htmlFor="samsung">Super power</label>
          </div>
          <div
            className="
               font-medium text-gray-600
          ...
          >
            <input type="checkbox" id="samsung" className="w-4 h-4 accent-blue-600"/>
            <label htmlFor="samsung">Large Memory</label>
          </div>
          <NavLink
