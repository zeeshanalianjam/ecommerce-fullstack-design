...
import { getUserDetails, imageUpload, login, logout, refreshToken, register, updateUserDetails, verifyEmailHandler } from '../controllers/user.controller.js';
...
userRouter.route('/refresh-token').post(jwtVerify, refreshToken)
